...
public class Arena {
    ...
    private final java.util.Set<org.bukkit.entity.Entity> persistentEntities = java.util.concurrent.ConcurrentHashMap.newKeySet();
    
    public void addPersistentEntity(org.bukkit.entity.Entity entity) {
        persistentEntities.add(entity);
    }

    public void removePersistentEntity(org.bukkit.entity.Entity entity) {
        persistentEntities.remove(entity);
    }

    public void clearPersistentEntities() {
    ...
    public void stop() {
        ...
        // Clear Ender Chests and Inventories for all players
    ...
    public void addPlayer(Player player) {
        ...
        // Clear player state and enderchest
    ...
    public void setGameState(GameState gameState) {
        ...
        if (gameState == GameState.PLAYING) {
            // Disable natural regeneration for the world
            if (!teams.isEmpty() && teams.get(0).getSpawnPoint() != null) {
                org.bukkit.World world = teams.get(0).getSpawnPoint().getWorld();
                if (world != null) {
